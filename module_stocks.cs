...
namespace OmniscentPOSAI
{
    public partial class module_stocks : Form
    {
        ...
        // tp_overView click event
        private void tp_overView_Click(object sender, EventArgs e)
        {
            LoadStockOverview();
        }
        ...
        // tp_addStock click event
        private void tp_addStocks_Click(object sender, EventArgs e)
        {
            LoadAddProducts();
        }
